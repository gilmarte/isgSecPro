...
public class Criteria extends Global implements Serializable {

	private static final long serialVersionUID = -3022924488767562562L;
	...
	private EnhancedCriterion enhancedCriterion;
	private int enhancedcriteria_id;
	

	private Set<EnhancedCriterion> enhancedCriterionSet = new HashSet<EnhancedCriterion>();

	public Criteria(){}

	public Criteria(TempCriteria tempCriteria)
	{
	...
	public void addToEnhancedCriteriaSet(EnhancedCriterion enhancedCriterion) {
		enhancedCriterionSet.add(enhancedCriterion);
		enhancedCriterion.setCriteria(this);
	}
	...
	public EnhancedCriterion getEnhancedCriterion() {
		return enhancedCriterion;
	}

	public void setEnhancedCriterion(EnhancedCriterion enhancedCriterion) {
		this.enhancedCriterion = enhancedCriterion;
	}

	public Set<EnhancedCriterion> getEnhancedCriterionSet() {
		return enhancedCriterionSet;
	}

	public void setEnhancedCriterionSet(Set<EnhancedCriterion> enhancedCriterionSet) {
		this.enhancedCriterionSet = enhancedCriterionSet;
	}

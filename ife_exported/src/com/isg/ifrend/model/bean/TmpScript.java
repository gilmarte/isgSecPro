 ...
 * 
 */
public class TmpScript extends Global implements Serializable {

	private static final long serialVersionUID = -9148341791071934934L;
	...
	public TmpScript(String scriptID, String countryCode, String functionCode,
	...
	public TmpScript(HstScript h) {
		this(h.getScriptID(), h.getCountryCode(), h.getFunctionCode(), h
				.getUserFieldID(), h.getPriorityID(), h.getDesc(), h

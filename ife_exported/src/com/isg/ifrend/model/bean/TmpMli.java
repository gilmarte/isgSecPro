 ...
 * 
 */
public class TmpMli extends Global implements Serializable {

	private static final long serialVersionUID = 5357829045822590754L;
	...
	public TmpMli(String mliID, String countryCode, String functionCode,
	...
	public TmpMli(HstMli h) {
		this(h.getMliID(), h.getCountryCode(), h.getFunctionCode(), h
				.getUserFieldID(), h.getResponseCodeID(), h.getDesc(), h
				.getMessageTypeID(), h.getMessage(), h.getCommentTypeID(), h
				.getComment(), h.getStatusID(), h.getActionID(), h
				.getCreatorUserID(), h.getDateCreated(), h.getApproverUserID(),
				h.getDateApproved(), h.getLastModifierUserID(), h
						.getDateLastModified());
	}

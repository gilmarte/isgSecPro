 ...
 * 
 */
public class Script extends Global implements Serializable {

	private static final long serialVersionUID = -6797644464229802825L;
	...
	public Script(String scriptID, String countryCode, String functionCode,
	...
	/**
	 * Copies TmpScript to Script
	 * 
	 * @param t
	 */
	public Script(TmpScript t) {
		this(t.getScriptID(), t.getCountryCode(), t.getFunctionCode(), t
				.getUserFieldID(), t.getPriorityID(), t.getDesc(), t
